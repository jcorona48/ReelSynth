                ...
                <div className="footer-info">
                    ...
                    <article className="footer-rigth">
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" href="https://github.com/JeyllonSandoval/Proyecto-Ing.Software.git" className="repost-git soport">Back-End</a><i className="fa-brands fa-github"></i></li>
                            <li><a target="_blank" href="https://github.com/jcorona48/ReelSynth" className="repost-git soport">Front-End</a><i className="fa-brands fa-github"></i></li>
                        </ul>
                    </article>
                </div>
            </footer>
